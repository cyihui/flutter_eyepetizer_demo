...
class _MinePageState extends State<MinePage>
  ...
  ImageProvider get avatarImage {
    if(_imageFile == null) {
      return const AssetImage('images/ic_img_avatar.png', package: 'module_person');
    } else {
  ...
  _settingListWidget() {
    return [
      _settingWidget('我的消息', callback: () {  }),
      _settingWidget('我的记录', callback: () {  }),
      _settingWidget('我的缓存', callback: () {  }),
      _settingWidget('观看记录', callback: () {
        toPage(WatchHistoryPage());
      }),
      _settingWidget('意见反馈', callback: () {  })
    ];
  }

  Widget _settingWidget(String text, {required VoidCallback callback}) {
    return InkWell(
      onTap: callback,
      child: Container(
        alignment: Alignment.center,
